...
figure(5)
plot(f_5_1, A_5_1, 'LineStyle','-.', 'Marker','x', 'MarkerSize',10, 'Color',clr(1))
hold on
plot(f_5_2, A_5_2, 'LineStyle','-.', 'Marker','x', 'MarkerSize',10, 'Color',clr(2))
plot(f_5_3, A_5_3, 'LineStyle','-.', 'Marker','x', 'MarkerSize',10, 'Color',clr(3))
plot(f_5_4, A_5_4, 'LineStyle','-.', 'Marker','x', 'MarkerSize',10, 'Color',clr(4))
xlabel("Częstotliwość [kHz]")
ylabel("Amplituda [mV]")
grid on
legend("C1", "C2","C3","C4", "Location","northeast")
title("Zależność amlitudy tętnień od częstotliwości")
text(40,40,{"Prąd obciążenia = 26 mA"},'FontSize',14)
